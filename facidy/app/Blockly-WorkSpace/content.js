...
import { generatedBlocklyBlocks } from "../UI-WorkSpace/elementsTree";
const INITIAL_TOOLBOX_JSON = {
  ...
  contents: [
    ...
    },
    {
      ...
      colour: 195,
      contents: [
        ...generatedBlocklyBlocks(
          JSON.parse(localStorage.getItem("elementParseTree"))
        ),
      ],
    },
  ],
...
const INITIAL_TOOLBOX_CATEGORIES = [
  ...
  {
    name: "Colour",
    blocks: [{ type: "colour_picker" }, { type: "colour_random" }],
  },
  {
    name: "Variables",
    custom: "VARIABLE",
